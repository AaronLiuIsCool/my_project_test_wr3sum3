...
import com.kuaidaoresume.web.view.error.ErrorPage;
import com.kuaidaoresume.web.view.error.ErrorPageFactory;
    ...
    public String handleError(HttpServletRequest request, Model model) {
        ...
        if (exception != null) {
            if (envConfig.isDebug()) {  // no sentry aop in debug mode
                ...
                logger.warn("Reported error to sentry", "id",
                        uuid.toString(), "error", exception);
            }
        }
