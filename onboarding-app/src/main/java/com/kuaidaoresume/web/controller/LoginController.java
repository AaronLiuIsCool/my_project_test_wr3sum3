...
import com.kuaidaoresume.account.dto.VerifyPasswordRequest;
...
import com.kuaidaoresume.web.view.LoginPage;
...
public class LoginController {
    ...
    public String login(@RequestParam(value="return_to", required = false) String returnTo, // POST and GET are in the same handler - reset
        ...
        String callBackScheme = envConfig.getScheme();
        String wechatCallbackUrl = HelperService.buildUrl(callBackScheme, "www." + envConfig.getExternalApex() + "/wechat-callback");
