package com.kuaidaoresume.kdr.controller;
...
import com.kuaidaoresume.kdr.exceptions.ForbiddenException;
import com.kuaidaoresume.kdr.view.ErrorPage;
import com.kuaidaoresume.kdr.view.ErrorPageFactory;
  ...
  public String handleError(HttpServletRequest request, Model model) {
    ...
    if (exception != null) {
      if (envConfig.isDebug()) {  // no sentry in debug mode
        ...
        errorPage.setSentryPublicDsn(kuaidaoresumeProps.getSentryDsn());
