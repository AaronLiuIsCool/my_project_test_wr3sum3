...
function getMockData(delay, key) {
  return new Promise((resolve) =>
    setTimeout(resolve, delay, workWrittenAssistantData[key]),
  );
}
...
export default class ResumeServices extends BaseServices {
  ...
  async updatePhotoReference(resumeId, url) {
    try {
      return await this.put(
        `v1/resumes/${resumeId}/photo-reference?value=${url}`,
      );
    } catch (exception) {
      logger.error(exception);
    }
  ...
  async createProject(resumeId, project) {
    try {
      return await this.post(
        `v1/resumes/${resumeId}/project-experiences`,
        project,
      );
    } catch (exception) {
      logger.error(exception);
  ...
  async createVolunteer(resumeId, volunteer) {
    try {
      return await this.post(
        `v1/resumes/${resumeId}/volunteer-experiences`,
        volunteer,
      );
    } catch (exception) {
      logger.error(exception);
  ...
  async createCertificate(resumeId, certificate) {
    try {
      return await this.post(
        `v1/resumes/${resumeId}/certificates`,
        certificate,
      );
    } catch (exception) {
      logger.error(exception);
  ...
  async getSuggestions(industry, title) {
    ...
    try {
      const data = await fetch(
        `/v1/get_suggestions_by_industry_position?industry=${industry}&limit=50&offset=0&position=${title}`,
      );
  ...
  async removeEducation(educationId, resumeId) {
    try {
      return await this.delete(
        `v1/educations/${educationId}?resumeId=${resumeId}`,
      );
    } catch (error) {
      logger.error(error);
    }
  ...
  async removeWork(workId, resumeId) {
    try {
      return await this.delete(
        `v1/work-experiences/${workId}?resumeId=${resumeId}`,
      );
    } catch (error) {
      logger.error(error);
    }
  ...
  async removeProject(projectId, resumeId) {
    try {
      return await this.delete(
        `v1/project-experiences/${projectId}?resumeId=${resumeId}`,
      );
    } catch (error) {
      logger.error(error);
    }
  ...
  async removeVolunteer(volunteerId, resumeId) {
    try {
      return await this.delete(
        `v1/volunteer-experiences/${volunteerId}?resumeId=${resumeId}`,
      );
    } catch (error) {
      logger.error(error);
    }
  ...
  async removeCertificate(certificateId, resumeId) {
    try {
      return await this.delete(
        `v1/certificates/${certificateId}?resumeId=${resumeId}`,
      );
    } catch (error) {
      logger.error(error);
    }
